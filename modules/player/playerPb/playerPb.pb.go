...
func (x *GetPlayerSavingAccountRes) GetBalance() int32 {
	if x != nil {
		return x.Balance
	}
	return 0
...
const file_modules_player_playerPb_playerPb_proto_rawDesc = "" +
	"\n" +
	"&modules/player/playerPb/playerPb.proto\"\xa7\x01\n" +
	...
	"\abalance\x18\x02 \x01(\x05R\abalance2\xf3\x01\n" +
	...
	"\x16GetPlayerSavingAccount\x12\x1a.GetPlayerSavingAccountReq\x1a\x1a.GetPlayerSavingAccountResB\x1eZ\x1cgithub.com/Hayato360/go_shopb\x06proto3"
