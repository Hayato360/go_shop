	...
	return Config{
		...
		Jwt: Jwt{
			...
			RefreshDuration: func() int64 {
				...
				if err != nil {
					log.Fatal("Error parse refresh duration")
				}
				return result
			}(),
		},
